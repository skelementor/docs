...
| **Elementor** | v4.0.0+ (beta 3.32.4+) | Atomic Elements required |
...
<CardGroup cols={2}>
  <Card title="Check System Health" icon="heart-pulse" href="/troubleshooting/common-errors">
...
<CardGroup cols={2}>
  ...
  <Card title="Explore Utility Framework" icon="book-open" href="/overview">
