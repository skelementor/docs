...
Use gap utilities to control the spacing between flex items. Gap is the modern way to add spacing between flex items without using margin utilities. These utilities work with a consistent 4px scale and include both static and fluid variants for responsive designs. The spacing scale is a core concept—see the [Spacing Overview](/overview/spacing#spacing-scale) for details.
...
<Steps>
  ...
  <Step title="Use the 4px Scale">
    Use the predefined spacing scale (1px, 1, 2, 3, 4, 6, 8, 12, and larger values) for consistency. See the [Spacing Overview](/overview/spacing#spacing-scale) for the complete scale.
  </Step>
