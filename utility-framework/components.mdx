...
<Card title="Button Sizes" icon="hand-pointer">
  ...
  |-------|---------|-----------|-------| | `.btn-sm` | 8px 16px | 14px | Small
  buttons | | `.btn-lg` | 16px 32px | 18px | Large buttons |
</Card>
...
<Card title="Button Colors" icon="palette">
  ...
  `.btn-blue` | #3b82f6 | White | Primary actions | | `.btn-green` | #10b981 |
  White | Success actions | | `.btn-red` | #ef4444 | White | Danger actions |
</Card>
...
<Card title="Container Base" icon="container">
```css
.cont {
  max-width: 1200px;
  margin-left: auto;
