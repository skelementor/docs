...
<Card title="Z-Index Levels" icon="layers">
  | Class | Level | CSS | Usage | |-------|-------|-----|-------| | `.z-0` | 0 |
  `z-index: 0;` | Base level | | `.z-10` | 10 | `z-index: 10;` | Low priority |
  | `.z-20` | 20 | `z-index: 20;` | Medium priority | | `.z-50` | 50 | `z-index:
  50;` | High priority | | `.z-100` | 100 | `z-index: 100;` | Highest priority |
</Card>
