...
<Card title="All Sides Margin" icon="arrows-horizontal">
...
<Card title="Horizontal Margin" icon="arrows-horizontal">
...
<Card title="Horizontal Padding" icon="arrows-horizontal">
...
<Card title="Vertical Padding" icon="arrows-vertical">
...
<Card title="Gap Properties" icon="arrows-horizontal">
