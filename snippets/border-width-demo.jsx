...
export const BorderWidthDemo = () => {
  ...
  const borderWidths = [
    ...
    { label: "border-2", width: "2px" },
    { label: "border-4", width: "4px" },
    { label: "border-8", width: "8px" }
  ];
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          {borderWidths.map((item) => (
            ...
            >
              ...
              className="border-blue-500 dark:border-blue-400 bg-blue-50/50 dark:bg-blue-950/30" />

              {copiedValue === item.label && (
                <span style={{ fontSize: '0.75rem', fontWeight: '600', marginLeft: '0.5rem', transition: 'opacity 0.2s ease' }}
