...
export const GapDemo = () => {
  ...
  const gapSizes = [
    { value: 0, label: "gap-0", pixels: "0px" },
    { value: 1, label: "gap-1", pixels: "4px" },
    { value: 2, label: "gap-2", pixels: "8px" },
    { value: 4, label: "gap-4", pixels: "16px" },
    { value: 6, label: "gap-6", pixels: "24px" },
    { value: 8, label: "gap-8", pixels: "32px" }
  ];
    ...
    <div className="not-prose" style={{ margin: '1.5rem 0' }}>
      ...
      className="bg-white border border-zinc-200 dark:bg-zinc-900 dark:border-zinc-800">
        ...
        <div style={{ padding: '1.5rem', borderRadius: '0.5rem', transition: 'all 0.2s ease' }}
          ...
          <div style={{
            display: 'flex',
            gap: gapSizes.find(s => s.value === selectedGap)?.pixels,
