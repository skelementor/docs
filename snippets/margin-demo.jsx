...
export const MarginDemo = () => {
  ...
  const marginSizes = [
    { value: 1, label: "m-1", pixels: "4px" },
    { value: 2, label: "m-2", pixels: "8px" },
    { value: 4, label: "m-4", pixels: "16px" },
    { value: 6, label: "m-6", pixels: "24px" },
    { value: 8, label: "m-8", pixels: "32px" },
    { value: 12, label: "m-12", pixels: "48px" }
  ];
    ...
    <div className="not-prose" style={{ margin: '1.5rem 0' }}>
      ...
      className="bg-white border border-zinc-200 dark:bg-zinc-900 dark:border-zinc-800">
        ...
        <div style={{ display: 'flex', justifyContent: 'center', padding: '1.5rem', borderRadius: '0.5rem', transition: 'all 0.2s ease' }}
          ...
          <div style={{
            padding: marginSizes.find(s => s.value === selectedSize)?.pixels,
            border: '2px dashed',
            borderRadius: '0.5rem',
            transition: 'all 0.3s ease'
          }}
          className="border-zinc-400 dark:border-zinc-500 bg-zinc-100/50 dark:bg-zinc-700/30">
            <div style={{
              padding: '1rem 1.5rem',
              borderRadius: '0.375rem',
              textAlign: 'center',
            ...
            className="bg-blue-500 dark:bg-blue-600 text-white shadow-sm">
              .{marginSizes.find(s => s.value === selectedSize)?.label}
            </div>
          </div>
        </div>
        ...
        <div style={{ marginTop: '0.75rem', fontSize: '0.75rem', textAlign: 'center', transition: 'color 0.2s ease' }}
          ...
          Dashed border shows the margin area
        </div>
      </div>
    </div>
  );
